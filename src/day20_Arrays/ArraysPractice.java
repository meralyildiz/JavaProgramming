...
public class ArraysPractice{
    public static void main(String[] args) {
        ...
        int[] elements = {10,20,50,70}; //size:4
        System.out.println(Arrays.toString(elements));

        System.out.println("--------------------------------------------------------");

        //create a variable that van contain 5 scores
  ...
  */
        ...
        for (int i = months.length-1; i >= 0 ; i--) { //i: represents the index number of array starting from the last index number
            System.out.println(months[i]);
